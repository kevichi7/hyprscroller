...
public:
  ...
  void push_back(T value) { emplace_after(m_last, value); }
  void push_front(T value) { emplace_before(m_first, value); }
  ...
  void insert_before(ListNode<T> *it, T value) { emplace_before(it, value); }
  void insert_after(ListNode<T> *it, T value) { emplace_after(it, value); }
